...
public class BooleanSettingComponent extends SettingComponent {
    ...
    public BooleanSettingComponent render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        float trackRadius = InterfaceStyle.radius(4f, 1.5f);
        float knobRadius = InterfaceStyle.radius(2f, 1f);
        ...
        QuickApi.rectangle()
                ...
                .radius(new RadiusState(trackRadius))
        ...
        QuickApi.rectangle()
                ...
                .radius(new RadiusState(knobRadius))
