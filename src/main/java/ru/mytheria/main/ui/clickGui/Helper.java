...
import ru.mytheria.main.ui.clickGui.components.settings.colorsetting.ColorPickerComponent;
...
public final class Helper {
    ...
    public static SettingComponent find( Setting settingLayer) {
        ...
        if (settingLayer instanceof ColorSetting colorSetting) return new ColorPickerComponent(colorSetting);
