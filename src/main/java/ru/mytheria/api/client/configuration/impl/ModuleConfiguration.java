...
public class ModuleConfiguration {
    ...
    public static void parseJson(Gson gson, Reader reader) {
        ...
        jsonElement.getAsJsonArray().asList().forEach(e -> {
            ...
            Module moduleLayer = Mytheria.getInstance().getModuleManager().filter(
                    module -> module.getModuleName().getString().equalsIgnoreCase(jsonObject.get("Module-Name").getAsString())
